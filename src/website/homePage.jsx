  ...
  return (
    ...
    <section className="container-fluid bg-white">
      <div className="row mt-5">
          <div className="col-12 col-sm-6 mt-4 pt-5">
            <img loading="lazy" className="w-75 mx-5" src={whychooseus} alt="image"/>
          </div>
          <div className="col-12 col-sm-6 mt-4 pt-5">
          <h3 className="text-center">Why Choose Us?</h3>
                 <ul className="fs-5 my-2">
             ...
             <div className="row">
              <section className="col mb-0 pb-0 mb-sm-5 pb-sm-4 what-client-says-section">
                <div className="col what-client-says-animation">
                    <h2 className="fw-bold fs-3 text-center mb-5">What Client Says</h2>
                    <div className="mx-3">
                      <Carousel  itemsToShow={items} showArrows={true} pagination={false} >
                        {data.map((item, i) => (
                          <div className="d-flex">
                            <div className='fs-5 justify-content-center overflow-auto testimonial-card-container'>
                            <div className='d-flex fw-bold justify-content-center mt-4 mx-4'>
