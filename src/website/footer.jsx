    ...
    return (
        <div class="bg-dark d-flex text-center text-white w-100 container-fluid flex-column">
          <div class="row">
            ...
            <div class="col-4 col-sm-3 align-items-baseline d-flex flex-column">
                  <h5 className='mt-3'>Quick links</h5>
                  <Link className='mt-2 mt-sm-4 footer-link' to="/" onClick={scrollToTop}>Home</Link> 
             ...
             <div className='col-4 col-sm-6 d-flex flex-column flex-sm-row justify-content-sm-around'>
            <div class="align-items-baseline d-flex flex-column">
               <h5 className='mt-3'>Company</h5>
               <Link className='mt-2 mt-sm-4 footer-link text-start' to="/termsconditions">Terms & Conditions</Link>
            ...
            <div className='align-items-baseline d-flex flex-column'>
              ...
              <div className='icons mt-1 mt-sm-4'>
